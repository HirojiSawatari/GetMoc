program poptrans
  ...
  !should use a relatively small value for nphi compared to the number of latitude 
  !in the model. This value is input from mocdec.csh
  integer :: nphi=181
...
! if (jmt == 384) gridfile = 'ccsm2_ocn.nc'
  ...
  do i = 1,nvars
     ...
     case ('REGION_MASK')
        ...
        where (region_mask == 7) ; amaskt = 1 ; endwhere
